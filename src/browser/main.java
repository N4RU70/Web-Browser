        ...
        try {
            ...
            history.getEntries().addListener((ListChangeListener<WebHistory.Entry>) c -> {
                        ...
                        for (WebHistory.Entry e1 : c.getAddedSubList()) {
                            ...
                            t.setText(e1.getUrl());
                            if (e.getLocation().replace("www.", "").substring(e.getLocation().indexOf("https://") + 9, e.getLocation().indexOf("com") - 1).equals("start.duckduckgo.com")) {
                                t1.setText("New Tab");
                            } else {

                                t1.setText(e.getLocation().replace("www.", "").substring(e.getLocation().indexOf("https://") + 8, e.getLocation().indexOf("com") - 1));
